...
public class GoodsServiceImpl implements GoodsService {
	...
	public List<Goods> getAllGoods(int start, int length) 
		...
		result = goodMapper.getAllGoods(start, length);
		return result;
	}
	...
	public Long getCatalogGoodsTotalRows(int catalog){
		return goodMapper.getCatalogGoodsTotalRows(catalog);
	}
	...
	public List<Goods> findGoodsByKey(String key) throws UserException{
		...
		result = goodMapper.findGoodsByKey(key);
	...
	@Override
	public void updateGoods(Goods goods) throws UserException{
		if (goods.getId() == -1){
			throw new UserException("id未设置，请设置id");
		}
